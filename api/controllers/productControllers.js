...
module.exports.createProduct = async (req, res) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        const { error } = validate(_.pick(fields, ["name", "description", "unit", "price", "category", "quantity"]));
            ...
            fs.readFile(files.photo.path, (err, data) => {
                ...
                product.save((err, result) => {
                    if (err) res.status(500).send("Internal Server error!");
                        ...
                        data: _.pick(result, ["name", "description", "unit", "price", "category", "quantity"])
                    })
                })
            })
        } else {
...
module.exports.updateProductById = async (req, res) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        const updatedFields = _.pick(fields, ["name", "description", "unit", "price", "category", "quantity"]);
